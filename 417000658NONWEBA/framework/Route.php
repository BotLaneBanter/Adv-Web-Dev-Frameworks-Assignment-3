...
class Route{
    ...
    public static function run($basepath = '', $case_matters = false, $trailing_slash_matters = false, $multimatch = false) {
      ...
      echo "Parse Current URL: " . var_dump($parsed_url);
      echo "<br>";
      ...
      if (isset($parsed_url['path'])) {
        // If the trailing slash matters
          if ($trailing_slash_matters) {
              ...
              echo "If The Trailing Slash Matters: " . $path;
              echo "<br>";
          } else {
          ...
          if($basepath.'/' != $parsed_url['path']) {
            ...
            echo "Cut the trailing slash away because it does not matters: " . $path;
            echo "<br>";
          } else {
            $path = $parsed_url['path'];
            echo "Path: " . $path;
      ...
      foreach (self::$routes as $route) {
        ...
        if ($basepath != '' && $basepath != '/') {
          ...
          echo "Add Basepath To Matching String: " . $route['expression'];
          echo "<br>";
        }
  
        // Add 'find string start' automatically
        $route['expression'] = '^'.$route['expression'];
        echo "Add Find String Start To Matching String: " . $route['expression'];
        echo "<br>";
  
        // Add 'find string end' automatically
        $route['expression'] = $route['expression'].'$';
        echo "Add Find String End To Matching String: " . $route['expression'];
        echo "<br>";
